...
%>
 ...
 <head><meta http-equiv="Content-Type" content="text/html; charset=euc-kr">
   ...
   function winsend() {
	   ...
	   var url = "board_delete.do?page=${page}&idx=<%=idx%>&name=<%=vo.getName()%>&userid=${user.userid}";
		window.open(url, "board_delete","width=400, height=170");
	}
   </script>
   ...
   <table border="0" width="800">
     <tr>
      ...
      <font size="2">
	   ...
	   <!-- 수정하기 -->
       <a href="board_modify.do?page=${page}&idx=<%=idx%>">
       <img src="Board/img/edit.gif" border="0"></a>&nbsp;&nbsp;
         <!-- 삭제하기 -->
       <a href="javascript:winsend()"><img src="Board/img/del.gif" border="0"></a>&nbsp;&nbsp;
       <!-- 목록보기 -->
