<%@page import="java.util.List,exSample.*"%>
...
<table border="0" width="800">
  <tr>
	...
	<!-- 다음에 추가할 부분 --><%@ include file="/Include/login_form.jsp" %></td>
...
<c:forEach var="list" items="${list }">
		<tr onMouseOver="style.backgroundColor='#D1EEEE'" onMouseOut="style.backgroundColor=''">
			...
			<td align="left" height="20">&nbsp;
				...
				<a class="list" href="board_view.do?idx=${list.idx }&page=${page}">${list.subject }</a></td>
	...
	<table width="600">
		<tr>
			...
			<td width="50%" align="center">
				<table>
					<form name = "board" action="/board_list.do" method="post">	
